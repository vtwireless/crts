...
function onWebSocketConnect(ws) {
    ...
    function checkControllerPermission(programName, controlName,
        parameterName, setOrGet) {
    ...
    io.On('setParameter', function(programName, controlName,
        ...
        if(checkControllerPermission(programName, controlName,
                parameterName, 'set')) {
            spew("GOT 'setParameter' (" + [].slice.call(arguments) +
                ') permission denied');
            return;
...
function addAdminConnection(io, wsId, spew) {
    ...
    io.On('changePermission', function(user, programName, setGet,
        ...
        function barf() {  spew("On 'changePermission' (" +
            [].slice.call(arguments) + ') failed data not consisent');
            return true;
        }
