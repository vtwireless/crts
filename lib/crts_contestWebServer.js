...
// users is used for authentication.
//
//var users = opt.users;
...
function addControllerCB(controller) {
    ...
    Object.keys(sessions.admin.ios).forEach(function(wsId) {
        sessions.admin.ios[wsId].Emit('addController',
...
function onWebSocketConnect(ws) {
    ...
    require('./socketIO')(io, function(msg) { ws.send(msg); }, spew);
    ...
    ws.on('message', function(message) {
        ...
        if(userName === 'admin')
            addAdminConnection(io, spew);

    });
}


function addAdminConnection(io, spew) {

    ///////////////////////////////////////////////////////////////
    //
    //  Here: This webSocket connection is from an admin.
    //
    //  io   - is the socketIO-like thingy for this connection.
    //
