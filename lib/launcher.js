...
//     "/rx2": false
// }
// launcherPermissions is a object reference that has values
// that can change as the server runs.  Note: it is just for this
// userName.
//
function initConnection(io, spew, userName, launcherPermissions) {
