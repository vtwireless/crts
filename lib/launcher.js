...
function initConnection(io, spew) {
    ...
    //   run it again.
    //
    io.On('launch', function(path_in, args, opts = {}) {
        ...
        // Each launched program gives a launch ID the is unique for a
        // given server run.  If the server runs a long time these may
        // wrap back through 0.
